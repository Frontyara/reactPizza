...
export default function Cart() {
  ...
  const items = useSelector((state:{cartReducer: any}) => state.cartReducer.items)
  const totalPizzas = useSelector((state:{cartReducer: any}) => state.cartReducer.totalPizzas)
  const totalPrice = useSelector((state:{cartReducer: any}) => state.cartReducer.totalPrice)
